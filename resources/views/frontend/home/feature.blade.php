                        ...
                        <div class="lower-content">
                            <div class="clearfix author-info">
                                <div class="author pull-left">
                                    ...
                                    <figure class="author-thumb"><img src="{{ asset('frontend/assets/images/feature/author-1.jpg') }}" alt=""></figure>
                                          ...
                                          <figure class="author-thumb"><img src="{{ (!empty($item->user->photo)) ? url('upload/agent_image/'.$item->user->photo) : url('upload/no_image.jpg') }}" alt=""></figure>
                            ...
                            <div class="clearfix price-box">
                                ...
                                <ul class="clearfix other-option pull-right">
                                    <li><a href="{{ url('property/details/'.$item->id.'/'.$item->property_slug) }}"><i class="icon-12"></i></a></li>
                                    <li><a href="{{ url('property/details/'.$item->id.'/'.$item->property_slug) }}"><i class="icon-13"></i></a></li>
                                </ul>
                            </div>
