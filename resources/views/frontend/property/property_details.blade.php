...
@section('main')
    ...
    <section class="property-details property-details-one">
        <div class="auto-container">
            <div class="clearfix top-details">
                <div class="clearfix left-column pull-left">
                ...
                <div class="clearfix right-column pull-right">
                    <div class="clearfix price-inner">
                        <ul class="clearfix category pull-left">
                                    ...
                                    <div class="inner">
                                        ...
                                        @foreach ($facility as $item)
                                            <div class="clearfix box">
                                                ...
                                                <ul class="clearfix rating pull-right">
                                                    <li><i class="icon-39"></i></li>
                                                    <li><i class="icon-39"></i></li>
                                                    <li><i class="icon-39"></i></li>
                                                    <li><i class="icon-39"></i></li>
                ...
                <div class="property-sidebar default-sidebar">
                    ...
                    <div class="card">
                        <button type="submit" class="theme-btn btn-one"
                            onClick="addToCart(
                                {{ $property->id }},
                                '{{ addslashes($property->property_name) }}',
                                '{{ $property->property_slug }}',
                                {{ $property->agent_id }},
                                {{ $property->lowest_price ?? 0 }},
