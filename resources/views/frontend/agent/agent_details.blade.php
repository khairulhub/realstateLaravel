            ...
            <div class="auto-container">
                <div class="agent-details-content">
                    <div class="agents-block-one">
                        <div class="mr-0 inner-box">
<figure class="image-box"><img src="{{ (!empty($agent->photo)) ? url('upload/agent_image/'.$agent->photo) : url('upload/no_image.jpg') }}" alt="" style="width:270px; height:330px;" ></figure>
...
<div class="clearfix upper">
    ...
    <ul class="clearfix social-list pull-right">
...
<div class="author-box pull-right">
  ...
  @else
   ...
   <div class="author-box pull-right">
        <figure class="author-thumb">
            <img src="{{ (!empty($item->user->photo)) ? url('upload/agent_image/'.$item->user->photo) : url('upload/no_image.jpg') }}" alt="">
